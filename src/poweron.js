...
export default function (hljs) {
  ...
  const VARIABLES = {
    match: [
      regex.concat(/\b/, noneOf(...RESERVED_WORDS), /\b/),
      POWERON_IDENT_RE
    ],
    scope: { 2: 'variable' },
    relevance: 0

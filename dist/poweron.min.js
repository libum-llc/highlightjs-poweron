...
match:A.concat(/\b/,A.either(...I),/\b/),scope:"variable.constant",relevance:0
},{match:A.concat(/\b/,A.either(...P),/\b(?=\:|\s+)/),scope:"built_in",
relevance:0},{match:A.concat(/\b/,A.either(...O),/(?=\()|\s+(?=\()/),
scope:"title.function",relevance:0},{match:A.concat(/\b/,A.either(...L),/\b/),
scope:"title.function",relevance:0},{match:A.concat(/\b/,A.either(...C),/\b/),
scope:"built_in",relevance:0},{match:/(?<=(\bprocedure|call\b)\s+)\w+/,
scope:"title.function",relevance:0}],U=[...I,...S,...C,...P],Y={
match:[A.concat(/\b/,((...E)=>A.concat("(?!",E.join("|"),")"))(...U)),T],scope:{
2:"variable"},relevance:0},W={match:"@"+T,scope:"variable",relevance:0};return{
name:"PowerOn",aliases:["poweron"],case_insensitive:!0,keywords:G,contains:[M,{
match:/#INCLUDE\b/,scope:"keyword",relevance:0},{match:/\b\d+(\.\d+)?\b/,
scope:"number",relevance:0},F,{match:/[\[\]\(\)\{\}:;,]/,scope:"punctuation",
relevance:0},...e,H,{match:A.concat(/(?<=:)\b/,T,/\b/),scope:"property",
relevance:0},W,Y]}}})();hljs.registerLanguage("poweron",E)})();